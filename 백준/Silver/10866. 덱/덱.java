...
class Main {
    public static void main(String[] args) throws IOException{
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (input[0].equals("push_front")) que.addFirst(Integer.parseInt(input[1]));
            else if (input[0].equals("push_back")) que.add(Integer.parseInt(input[1]));
            else if (input[0].equals("pop_front")) {
                if (!que.isEmpty()) System.out.println(que.pollFirst());
                else System.out.println(-1);
            } else if (input[0].equals("pop_back")) {
                if (!que.isEmpty()) System.out.println(que.pollLast());
                else System.out.println(-1);
